...
// Elenco ingredienti di partenza: derivato dagli ingredienti già usati nelle ricette di default
...
function openRecipeDetail(recipeId) {
    ...
    function renderDetailContent() {
        ...
        // Applica l'altezza reale agli step aperti per una transizione fluida (max-height dinamico)
...
document.getElementById("form-add-recipe").onsubmit = (e) => {
    ...
    // Parsing ingredienti nel formato "nome:quantita:unita" separati da virgola
    ...
    // Ogni ingrediente nuovo inserito qui entra automaticamente ne "I miei ingredienti"
...
// Autocomplete ingredienti nel form Nuova Ricetta, basato su "I miei ingredienti"
